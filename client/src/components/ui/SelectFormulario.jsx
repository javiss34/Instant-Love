//Componente para los selects desplegables
//Muy parecido a InputFormulario
const SelectFormulario = ({
  ...
  error,
  required = false,
  children /* Permite que el componente padre le inyecte las etiquetas <option> de forma dinámica */,
}) => {
  return (
