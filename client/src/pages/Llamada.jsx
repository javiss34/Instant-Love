      ...
      <div className="shrink-0 flex items-center justify-between gap-4 p-4 bg-slate-800 border-t border-slate-700">
        ...
        <div className="flex gap-2 md:gap-4">
          <button
            ...
            disabled={colgando}
            className="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 md:px-8 md:py-3 text-sm md:text-base rounded-xl shadow-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={colgando}
            className="bg-white text-gray-800 font-semibold px-4 py-2 md:px-8 md:py-3 text-sm md:text-base rounded-xl shadow-lg hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Siguiente ⏭️
          </button>
        </div>
