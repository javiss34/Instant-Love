...
const actualizarEstado = async (id, estado, nota_revision) => {
  ...
  //Si se marca como revisado, el admin tiene que explicar qué hizo
  ...
  //Si se sanciona, desactivamos la cuenta del acusado automáticamente
  //Solo lo hacemos si la cuenta está activa para no lanzar una actualización innecesaria
